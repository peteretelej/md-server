...
async def basic_remote_usage():
    ...
    try:
        ...
        print(f"✓ Remote conversion successful")
...
async def authenticated_remote_usage():
    ...
    try:
        ...
        print(f"✓ Authenticated conversion successful")
    ...
    for filename in local_files:
        try:
            ...
            if filename.endswith('.html'):
                content = f"<h1>{filename}</h1><p>HTML content for {filename}</p>".encode()
...
async def remote_url_processing():
    ...
    for url in urls:
        try:
            ...
            print(f"✓ Remote URL conversion successful")
...
async def remote_context_manager():
    ...
    async with MDConverter.remote("http://localhost:8080") as converter:
        try:
            ...
            print(f"✓ Context manager cleanup handled automatically")
...
async def sync_remote_api():
    ...
    try:
        ...
        print(f"✓ Sync remote conversion successful")
        print(f"✓ Result: {result.markdown}")
