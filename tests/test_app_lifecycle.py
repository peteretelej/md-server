...
class TestAppStartup:
    ...
    def test_startup_logging_configuration(self):
        ...
        with patch('md_server.app.logging.basicConfig') as mock_basic_config, \
...
class TestAppConfiguration:
    ...
    def test_app_middleware_configuration_with_auth(self):
        ...
        with patch('md_server.app.get_settings', return_value=mock_settings), \
             patch('md_server.app.create_auth_middleware', return_value=mock_auth_middleware):
...
class TestAppShutdown:
    ...
    def test_cleanup_on_exception_during_startup(self):
        ...
        with patch('md_server.app.startup_browser_detection', side_effect=Exception("Startup failed")):
