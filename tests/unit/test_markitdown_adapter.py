...
class TestMarkItDownAdapter:
    ...
    def test_conversion_context_success(self):
        ...
        with adapter._conversion_context("test") as ctx:
            pass
    ...
    def test_get_markitdown_instance_import_error(self):
        ...
        with patch('markitdown.MarkItDown', side_effect=ImportError):
            with pytest.raises(MarkdownConversionError, match="markitdown library not installed"):
    ...
    def test_sync_convert_file_success(self):
        ...
        with patch.object(adapter, '_get_markitdown_instance') as mock_get_md:
            ...
            with patch('markitdown.StreamInfo') as mock_stream_info:
    ...
    async def test_health_check_failure(self):
        ...
        with patch.object(adapter, '_get_markitdown_instance', side_effect=Exception("test error")):
    ...
    def test_get_configuration_info(self):
        ...
        with patch.object(adapter, 'get_supported_formats', return_value=[".txt", ".pdf"]):
