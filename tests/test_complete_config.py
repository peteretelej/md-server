...
class TestCompleteConfiguration:
    ...
    def test_azure_doc_intel_configuration(self, monkeypatch):
        monkeypatch.setenv("MD_SERVER_AZURE_DOC_INTEL_ENDPOINT", "https://test.cognitiveservices.azure.com")
    ...
    def test_default_values(self):
        ...
        assert settings.crawl4ai_max_pages == 10
        assert settings.crawl4ai_user_agent == "md-server/1.0"
    ...
    def test_all_configuration_fields_together(self, monkeypatch):
        ...
        monkeypatch.setenv("MD_SERVER_CRAWL4AI_MAX_PAGES", "15")
        ...
        assert settings.crawl4ai_max_pages == 15