...
class TestMarkItDownFactory:
    ...
    def test_create_with_no_services(self, basic_settings):
        ...
        with patch("md_server.factories.MarkItDown") as mock_markitdown:
            ...
            MarkItDownFactory.create(basic_settings)
    ...
    def test_create_with_all_services(self, full_settings):
        ...
        with (
            patch("md_server.factories.MarkItDown") as mock_markitdown,
            patch(
                "md_server.factories.MarkItDownFactory._create_llm_client"
            ) as mock_llm,
            patch(
                "md_server.factories.MarkItDownFactory._create_azure_credential"
            ) as mock_azure,
        ):
            ...
            MarkItDownFactory.create(full_settings)
    ...
    def test_mixed_proxy_configuration(self):
        ...
        assert (
            session.proxies.get("http") != settings_https.https_proxy
        )  # Should not be set
    ...
    def test_factory_integration(self, full_settings):
        ...
        with (
            ...
            assert (
                call_kwargs["docintel_endpoint"]
                == full_settings.azure_doc_intel_endpoint
            )
