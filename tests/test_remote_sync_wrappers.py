...
class TestRemoteSyncWrappers:
    ...
    def client(self):
        ...
        return RemoteMDConverter(
            endpoint="http://127.0.0.1:8999", timeout=5, max_retries=1
        )
    ...
    def test_convert_text_sync(self, client, success_mock_response):
        ...
        with patch.object(
            client._client, "request", return_value=success_mock_response
        ):
    ...
    def test_sync_methods_with_options(self, client, success_mock_response):
        ...
        with patch.object(
            ...
            result = client.convert_text_sync(
                "test", "text/plain", **conversion_options
            )
    ...
    def test_sync_methods_file_operations(
        self, client, success_mock_response, tmp_path
    ):
