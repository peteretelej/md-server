...
class TestSDKCoreUtils:
    ...
    @pytest.mark.parametrize(
        "attempt,max_retries,exception_type,expected",
        [
...
class TestErrorMapper:
    ...
    @pytest.mark.parametrize(
        "input_type,request_data,expected",
        [
...
class TestSDKValidation:
    ...
    def test_validate_conversion_options_valid(self):
        ...
        expected = {"js_rendering": True, "timeout": 30, "extract_images": False}
        assert result == expected
